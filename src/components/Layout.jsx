...
const navItems = {
  ...
  admin: [
    ...
    { path: "/dashboard/vendors",   icon: "◇", label: "Vendor Approval" },
    { path: "/dashboard/impact",    icon: "◉", label: "Impact Dashboard" },
  ],
};
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: collapsed ? "20px 16px" : "24px 20px", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ width: 36, height: 36, background: "var(--accent)", borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontFamily: "Syne", fontWeight: 800, fontSize: 16, color: "white" }}>
            E
          </div>
          {!collapsed && (
            <div>
              <div style={{ fontFamily: "Syne", fontWeight: 800, fontSize: 16, letterSpacing: "-0.5px" }}>ESP</div>
              <div style={{ fontSize: 10, color: "var(--text3)", textTransform: "uppercase", letterSpacing: 1 }}>Platform</div>
            </div>
          )}
        </div>
        ...
        {!collapsed && (
          <div style={{ padding: "12px 20px", borderBottom: "1px solid var(--border)" }}>
            <span className={`badge ${role === "admin" ? "danger" : role === "vendor" ? "active" : "verified"}`}>
              {role}
            </span>
          </div>
        )}
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: active ? "rgba(99,132,255,0.12)" : "transparent",
                  color: active ? "var(--accent)" : "var(--text2)",
                  fontFamily: "Syne", fontWeight: active ? 600 : 500, fontSize: 14,
        ...
        <div style={{ padding: "12px 8px", borderTop: "1px solid var(--border)", display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          {!collapsed && (
            <div style={{ padding: "12px 14px", borderRadius: "var(--radius-sm)", background: "var(--surface)" }}>
      ...
      <main style={{ flex: 1, overflow: "auto", minHeight: "100vh" }}>
        ...
        <div style={{ padding: "16px 32px", borderBottom: "1px solid var(--border)", background: "var(--bg2)", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 10, backdropFilter: "blur(12px)" }}>
          ...
          <button
            ...
            style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 16px", background: "var(--accent)", border: "none", borderRadius: "var(--radius-sm)", color: "white", cursor: "pointer", fontFamily: "Syne", fontWeight: 600, fontSize: 13 }}
          >
            💬 Help
          </button>
        </div>
